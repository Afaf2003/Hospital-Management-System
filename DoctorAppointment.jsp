...
<nav class="navbar sticky-top navbar-expand-lg navbar-light" style="background-color: #e3f2fd;">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <form class="d-flex" action="DoctorAppointment.jsp">
                    <input class="form-control me-2" type="number" placeholder="Search" aria-label="Search" name="did">
    ...
    <div class = "container">
        <table class="table table-bordered">
            <thead>
              <tr>
                <th style="text-align: center;" colspan="7"><h3>Appointments Details</h3></th>
              </tr>
            </thead>
            <tbody>
            <tr>
	...
	try{
		...
		int name=Integer.parseInt(request.getParameter("did"));
		String sql = "Select Ename,dates from Employee , appointment where Employee.Empid = appointment.Empid and Employee.Empid = ?";
		String sql1="Select patient_detail.pid, pname, disease, timest, timend,dates from patient_detail, patient_disease,  appointment where patient_detail.pid = patient_disease.pid and patient_disease.pid = appointment.pid ";
		...
		if(cT.equals(rs.getString(2))&& cT.equals(rs1.getString(6)))
		{
			int pid=rs1.getInt("pid");
			String pname=rs1.getString("pname");
			String disease=rs1.getString("disease");
			
			String ts=rs1.getString("timest");
			String tn=rs1.getString("timend");
