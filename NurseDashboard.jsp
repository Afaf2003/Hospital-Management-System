...
<body style = "font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;">
  ...
  <div class="container background">
    ...
    <a href="NursePatientAdd.jsp">
      <div class="btn btn-outline-success btn-lg">Add Details</div>
    </a>
    <a href="NurseLogin.jsp">
      <div class="btn btn-outline-success btn-lg">Patient Details</div>
    </a>
    <a href="AppointmentDetail.jsp">
      <div class="btn btn-outline-success btn-lg">Appointment Details</div>
    </a>
  </div>
</body>
