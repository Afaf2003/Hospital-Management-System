...
<nav class="navbar sticky-top navbar-expand-lg navbar-light" style="background-color: #e3f2fd;">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <form class="d-flex" action="DoctorPatientDetail.jsp">
...
<%
	try{
		...
		String sql = "Select patient_nurse.pid, pname, phoneno, disease, Age, Weight, temp,  bp, bs, patient_nurse.visit, dis_detail, Prescription from patient_nurse, patient_detail, patient_disease, patient_doctor where patient_nurse.pid =  patient_detail.pid and patient_detail.pid = patient_disease.pid and patient_nurse.pid = patient_doctor.pid and  patient_detail.pid = ? and patient_nurse.visit = (select max(patient_nurse.visit) from patient_nurse)";
		...
		//{
			...
			String dis_detail=rs.getString("dis_detail");
      ...
      <table class="table table-bordered">
            ...
            <tbody>
              <tr>
                ...
                <th scope="row">Disease Detail</th>
          ...
          <form action="DoctorPatientAdd.jsp">
    	<div class = "a">
	...
	if(!rs.next()){
		%><script>
			alert("This patient with Patient ID "+ <%=name%> " Is not Register till Yet");
			window.location = 'DoctorDashboard.jsp';
		</script>
		<% 
	}
